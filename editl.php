...
<body>
    ...
    $no = $_GET['no'];
    $data = mysqli_query($koneksi, "select * from logbook_4 where no='$no'");
    while($d = mysqli_fetch_array($data)){
        ?>
        <div class="wrapper">
            <div class="registration_form">
                <div class="title">Buat Log Book</div>
                <form method="POST" action="updatel.php">
                    <div class="form_wrap">
                        <div class="input_wrap">
                            <input type="hidden" name="no" value="<?php echo $d['no'];?>">
                            <label for="tanggal">Tanggal</label>
                            <input type="date" id="tanggal" name ="tanggal" value="<?php echo $d['tanggal'];?>">
                        </div>
                        <div class="input_wrap">
                        ...
                        <div class="input_wrap">
                            ...
                            <textarea id="deskripsi" name="deskripsi" type="text" rows="3" cols="30" placeholder="Pelajaran saat magang..." value="<?php echo $d['deskripsi'];?>"></textarea>
                        </div>
                        <div class="input_wrap">
